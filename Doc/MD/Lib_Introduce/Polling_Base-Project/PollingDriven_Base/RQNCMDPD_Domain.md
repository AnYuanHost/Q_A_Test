...
问答节点迭代构造轮询机可执行映射域映射_定义域（RQNCMDPD_Domain, RecursionQuestionNodeConstructMapDomainPollingDriven_Domain）通过命名空间确定问答节点迭代构造轮询机可执行映射域映射的定义域格式。
